...
public class InitCache implements CommandLineRunner{
	...
	public static Map<String,SysDict> dictBaseCache = new HashMap<String,SysDict>();
	...
	public void run(String... args) throws Exception {
		...
		for(SysDict sd:dictAllList) {
			if(!dictBaseCache.containsKey(sd.getValue())) {
				dictBaseCache.put(sd.getValue(), sd);
			}			
		}
		...
		System.out.println("字典初始化条数："+dictBaseCache.size());
